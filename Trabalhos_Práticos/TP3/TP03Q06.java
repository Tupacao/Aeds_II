...
public class TP03Q06 {
    ...
    static void corrigirpriinpubin(String nomeArquivo) {
        ...
        try {
            ...
            // Escreva um caractere de nova linha
    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            pilha.insereFinal(vetorJogador[var]);
            flag = MyIO.readLine();
        ...
        for (int j = 0; j < operacoes; j++) {
            ...
            switch (comando) {
                case "I":
                    valor = MyIO.readInt();
                    pilha.insereFinal(vetorJogador[valor]);
                    break;
                case "R":
                    aux = pilha.removeFIM();
